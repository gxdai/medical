...
def main(args):
    ...
    train_filenames, train_labels = generateData(train_cls, step=args.dn_train, dpFlag=True, targetNum=700)
    ...
    if args.dn_test == 0:
        ...
        val_filenames, val_labels, _ = generateData(test_cls, step=args.dn_test, dpFlag=False)
